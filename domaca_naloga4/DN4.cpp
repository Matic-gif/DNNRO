...
int main() {
    ...
    {
        // Paralelizacija notranje zanke z uporabo OpenMP
#pragma omp parallel for

            // Zanka za iteracijo skozi vsak element vektorja T
        for (int jj = 0; jj < n; jj++) {
            ...
            // Posodabljanje vrednosti T[jj] na novo izračunano vrednost
            {
                T[jj] = d / A[jj][jj];  
            }
        }

        // Sinhronizacija vseh niti pred prehodom na naslednjo iteracijo
        // Vse niti morajo zaključiti svoje posodobitve T, preden nadaljujemo z naslednjim krogom

    }
    //Paralelizacija je mogoča, vendar zaradi sinhronizacije med nitmi, ki jih zahteva metoda, učinkovitost zmanjšana.
    // Vse niti morajo čakati, da ena zaključi posodobitev vrednosti, zato lahko ta pristop omeji hitrost izvajanja.
	// Čas računanja se zmanjša, čeprav nismo vplivalji na zunajo zanko, ki probi več časa za izvedbo.
